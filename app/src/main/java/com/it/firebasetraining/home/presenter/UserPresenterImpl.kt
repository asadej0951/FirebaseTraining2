package com.it.firebasetraining.home.presenter
...
class UserPresenterImpl(var view: UserContract.View?) : UserContract.Presenter {
    ...
    //ติดต่อดาต้าเบส 3 บรรทัด
    private var database = FirebaseDatabase.getInstance()//สร้างดาต้าเบส
    ...
    override fun addDefaultEmail() {
        ...
        map[KEY_EMAIL] = "asadejwongnak@gamil.com"
